...
scsp_update (s32 *bufL, s32 *bufR, u32 len)
{
   ...
   temp = cdda_next_in - cdda_out_left;
   outpos = (temp < 0) ? temp + sizeof(cddabuf.data) : temp;
   buf = &cddabuf.data[outpos];
